...
<div <?php echo $block_wrapper_attributes; ?>>
    <div class="curve top-curve" style="<?php echo $attributes['enableTopCurve'] ? "" : "display: none; " ?>height: <?php echo $attributes['topHeight']; ?>px; transform: <?php echo $topTransform; ?>;">
    ...
    <div class="curve bottom-curve" style="<?php echo $attributes['enableBottomCurve'] ? "" : "display: none; " ?>height: <?php echo $attributes['bottomHeight']; ?>px; transform: <?php echo $bottomTransform; ?>;">
